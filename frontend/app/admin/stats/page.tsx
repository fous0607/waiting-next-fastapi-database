        ...
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1 font-medium">매장의 주요 지표를 분석합니다.</p>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="relative">
                        <select
                            className="appearance-none bg-white border border-slate-200 text-slate-700 py-2 pl-4 pr-10 rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-slate-900 shadow-sm"
                    ...
                    <div className="flex items-center gap-3 bg-white p-1.5 rounded-2xl border border-slate-200 shadow-sm">
                        <div className="flex bg-slate-100 rounded-xl p-1">
                            {(['daily', 'weekly', 'monthly'] as Period[]).map((p) => (
                                ...
                                >
                                    {{ daily: '일간', weekly: '주간', monthly: '월간' }[p]}
                                </button>
                            ))}
                        </div>
