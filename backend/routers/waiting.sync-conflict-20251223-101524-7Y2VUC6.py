    ...
    try:
        ...
        if franchise_id:
            ...
            if monitoring_enabled:
                 ...
                 logger.info(f"Broadcasting new_user event: store_id={current_store.id}, franchise_id={franchise_id}")
            else:
                 logger.info(f"Skipping franchise broadcast (disabled by settings): store_id={current_store.id}")
        
        # Always broadcast to the store
